  ...
  <div class="row">
    <div class="col-md-6">
      <div class="panel panel-default" id="panelbg">
        <div class="panel-heading" id="headerbg">User Register</div>
            ...
            <div class="form-group">
              <div class="col-md-6 col-md-offset-4">
                <div class="checkbox">
                  ...
                  <span style="color:#FFF;">Remember Me</span> </label>
                </div>
              </div>
            </div>
            <div class="form-group">
    ...
    <div class="col-md-6">
      <div class="panel panel-default" id="panelbg">
        <div class="panel-heading" id="headerbg">Login</div>
        <div class="panel-body">
          <form class="form-horizontal" role="form" method="POST" action="{{ route('login') }}">
            {{ csrf_field() }}
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12  col-md-offset-6"> <a class="btn btn-link" href="{{ route('password.request') }}"> Forgot Your Password? </a> </div>
            </div>
          </form>
        </div>
      </div>
