...
<div class="container">
  <div class="breadcrumbs1">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">All Agents List</li>
    </ol>
  </div>
  <div class="row">
      ...
      <div class="panel panel-default" id="panelbg">
       ...
       <!-- 
            <div class="pull-right">
           	<a class="btn btn-primary" href="{{ url('agents/csv') }}">Export to Csv </a> 
            </div>
            <br /> -->
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{!! action('HomeController@activeagent', $agent->id) !!}"><i class="fa fa-check" aria-hidden="true" title="Active"></i></a>&nbsp;&nbsp;               
                      <a href="{!! action('HomeController@inactiveagent', $agent->id) !!}"><i class="fa fa-times" aria-hidden="true" title="InActive"></i></i></a>&nbsp;&nbsp;               
                      <a href="{!! action('HomeController@editagent', $agent->id) !!}"><img src="{{ asset('public/img/view.png') }}"/></a></td>
                    </tr>
                    <?php $i++; ?>
                    @endforeach
                  </tbody>
