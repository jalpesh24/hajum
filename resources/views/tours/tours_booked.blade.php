...
<ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"> Tour Booked </li>
</ol>
</div>
  <div class="row">
        ...
        <div class="panel-body">
          ...
          <div class="col-md-12">
            <table border="0" width="100%" id="tourslist" class="table">
              ...
              <tbody>
                <?php $i=1; ?>
              @foreach($tourbooked as $tour)
              <tr>
                <td>{!! $i !!}</td>
                <td>{!! $tour->firstname !!}</td>
                <td>{!! $tour->tour_name!!}</td>  
				<td>{!! $tour->orderstatus!!}</td>  				
                <td>               
                
                <a href="{!! url('detailview/'.$tour->order_id) !!}"><img src="{{ asset('public/img/view.png') }}"/></a>&nbsp;
                <a href="{!! action('ToursController@deleteorder', $tour->order_id) !!}" onclick="return delete_order();"><img src="{{ asset('public/img/delete.png') }}"/></a>
