...
<ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"> Add New Tour Daywise </li>
</ol>
</div>
  <div class="row">
          ...
          <form method="post" name="frm_add_tour_daywise">
            ...
            <div class="col-md-6 form-line">
              <div class="form-group">
                ...
                <input type="text" name="txt_day{!! $i !!}" id="txt_day{!! $i !!}" placeholder="Day {!! $i !!} Title" class="form-control" required="required"/>
              </div>
              <div class="form-group">
