        ...
        <div class="panel-body">
          ...
          <div class="col-md-12">
            <form method="post" name="frm_edit_tour_placevisit">
              ...
              @else
              <input type="hidden" name="hid_placevisit[{!! $i !!}]" value="" />
               <div class="col-md-6 form-line">
               	<div class="form-group">
                  	<label for="packagename">Place {!! $i !!} - Name</label>
                        <input type="text" name="txt_place{!! $i !!}" id="txt_place{!! $i !!}" placeholder="Place {!! $i !!} Name" class="form-control" required="required" value="" />
			</div>
                  <div class="form-group">
                  	<label for="packagename">Place {!! $i !!} - Description</label>
