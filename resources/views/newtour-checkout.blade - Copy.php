                  ...
                  <div class="col-xs-12 col-md-12 col-sm-12">
                    <div>
                      <h4><small> @if($tour[0]->adprice != '' && $tour[0]->adprice > 0)
						...
						<h4 class="text-right total">Total pay: <strong class="total">Rs. {!! ($tour[0]->adprice + $tour[0]->cdprice) - $discount !!}</strong></h4>
						@else
                        <h4 class="text-right totalpay">Total: <strong class="totalpay">Rs. {!! ($tour[0]->adprice + $tour[0]->cdprice) !!}</strong></h4>
                        <h4 class="text-right dis">Discount: <strong class="disc">Rs. {!! ($discount) !!}</strong></h4>
						<h4 class="text-right total">Total pay: <strong class="total">Rs. {!! ($tour[0]->adprice + $tour[0]->cdprice) - $discount !!}</strong></h4>
...
<script type="text/javascript">
	$("#txt_tour_date").datepicker().datepicker("setDate", new Date());
...
$(document).ready(function() 
{
	...
	$( "#no_of_persons" ).click(function() 
	{
		...
		if(persons > 0)
		{
			...
			$(".disamount").html('Total: INR '+totaldiscount);
			$(".totalpay").html('Total: INR '+total);
			$(".total").html('Total: INR '+amountpay);
	...
	$( "#no_of_persons" ).keyup(function() 
	{
		...
		if(persons > 0)
		{
			...
			$(".totalpay").html('Total: INR '+total);
			$(".total").html('Total: INR '+amountpay);
			$(".amount").html('Total: INR '+amountpay);
			$(".newamount").html('Total: INR '+amountpay);
