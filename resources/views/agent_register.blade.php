...
<ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Operator Register</li>
</ol>
</div>
  <div class="row">
    <div class="col-md-12"> 
    <h2 class="section-heading">Operator Register</h2>   
	...
	@if(Session::has('success'))
	    ...
	    @endif
          ...
          <form class="form-horizontal" role="form" method="POST" action="{{ url('/agent-register') }}">
            {{ csrf_field() }}     
            ...
            <div class="form-group">
              <div class="col-md-4 col-md-offset-4">
                <input id="trip_agent" type="hidden" name="trip_agent" value="1">
