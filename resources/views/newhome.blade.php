...
<link href="{{ url('public/newhtml/css/bootstrap.css') }}" rel="stylesheet">
<link href="{{ url('public/newhtml/css/jquery-ui.css') }}" rel="stylesheet">
<link href="{{ url('public/newhtml/css/font-awesome.min.css') }}" rel="stylesheet">
<!-- <link href="{{ url('public/newhtml/css/camera.css') }}" rel="stylesheet"> -->
<!-- <link href="{{ url('public/newhtml/css/prettyPhoto.css') }}" rel="stylesheet"> -->
<!-- <link href="{{ url('public/newhtml/css/isotope.css') }}" rel="stylesheet"> -->
<!-- <link href="{{ url('public/newhtml/css/animate.css') }}" rel="stylesheet"> -->
<link href="{{ url('public/newhtml/css/select2.css') }}" rel="stylesheet">
<link href="{{ url('public/newhtml/css/jquery-ui-1.css') }}" rel="stylesheet">
<link href="{{ url('public/newhtml/css/style.css') }}" rel="stylesheet">
<link href="{{ url('public/newhtml/css/css.css') }}" rel="stylesheet">
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery.js') }}"></script>
<style type="text/css">
          ...
          <div class="top2 clearfix">  
            <header>
              <div class="logo_wrapper margtop">
                <a href="{{ url('/') }}" class="logo scroll-to">	
                  <img src="{{ url('public/newhtml/images/logo.png') }}" alt="" class="img-responsive">
                </a>
              </div>
            </header>
          ...
          <div id="banner" class="banner" style="display: block; margin-bottom: 0px;">
              ...
              <div class="carousel-inner">
                <div class="item active">
                  <img src="{{ url('public/newhtml/images/slide04.jpg') }}" alt="Los Angeles" style="width:100%;">
                </div>
                <div class="item">
                  <img src="{{ url('public/newhtml/images/slide08.jpg') }}" alt="Chicago" style="width:100%;">
                </div>
                <div class="item">
                  <img src="{{ url('public/newhtml/images/slide09.jpg') }}" alt="New york" style="width:100%;">
                </div>
              </div>
  ...
  <div class="container">
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="services1">
            <figure>
              <img src="{{ url('public/newhtml/images/services5.png') }}" alt="" class="img-responsive">
            </figure>
            <div class="caption">
        ...
        <div class="col-sm-3">
          <div class="services1">
            <figure>
              <img src="{{ url('public/newhtml/images/services6.png') }}" alt="" class="img-responsive">
            </figure>
            <div class="caption">
        ...
        <div class="col-sm-3">
          <div class="services1">
            <figure>
              <img src="{{ url('public/newhtml/images/services7.png') }}" alt="" class="img-responsive">
            </figure>
            <div class="caption">
        ...
        <div class="col-sm-3">
          <div class="services1">
            <figure>
              <img src="{{ url('public/newhtml/images/services8.png') }}" alt="" class="img-responsive">
            </figure>
            <div class="caption">
  ...
  <div class="clearfix">
    <div class="tour1 clearfix">
      <a href="#" class="clearfix">
        <figure>
          <img src="{{ url('public/newhtml/images/tour01.jpg') }}" alt="" class="img-responsive">
        </figure>
        <div class="caption">
          <div class="txt1">family tour in greece</div>
          <div class="txt2">
            <div class="stars1">
              <img src="{{ url('public/newhtml/images/star1.png') }}" alt="">
              <img src="{{ url('public/newhtml/images/star1.png') }}" alt="">
              <img src="{{ url('public/newhtml/images/star1.png') }}" alt="">
              <img src="{{ url('public/newhtml/images/star1.png') }}" alt="">
              <img src="{{ url('public/newhtml/images/star1.png') }}" alt="">
    ...
    <div class="tour1 clearfix">
      <a href="#" class="clearfix">
        <figure>
          <img src="{{ url('public/newhtml/images/tour02.jpg') }}" alt="" class="img-responsive">
        </figure>
        <div class="caption">
          <div class="txt1">family tour in greece</div>
          <div class="txt2">
    ...
    <div class="tour1 clearfix">
      <a href="#" class="clearfix">
        <figure>
          <img src="{{ url('public/newhtml/images/tour03.jpg') }}" alt="" class="img-responsive">
        </figure>
        <div class="caption">
          <div class="txt1">family tour in greece</div>
          <div class="txt2">
    ...
    <div class="tour1 clearfix">
      <a href="#" class="clearfix">
        <figure>
          <img src="{{ url('public/newhtml/images/tour04.jpg') }}" alt="" class="img-responsive">
        </figure>
        <div class="caption">
          <div class="txt1">family tour in greece</div>
          <div class="txt2">
    ...
    <div class="tour1 clearfix">
      <a href="#" class="clearfix">
        <figure>
          <img src="{{ url('public/newhtml/images/tour05.jpg') }}" alt="" class="img-responsive">
        </figure>
        <div class="caption">
          <div class="txt1">family tour in greece</div>
          <div class="txt2">
    ...
    <div class="tour1 clearfix">
      <a href="#" class="clearfix">
        <figure>
          <img src="{{ url('public/newhtml/images/tour06.jpg') }}" alt="" class="img-responsive">
        </figure>
        <div class="caption">
          <div class="txt1">family tour in greece</div>
          <div class="txt2">
    ...
    <div class="tour1 clearfix">
      <a href="#" class="clearfix">
        <figure>
          <img src="{{ url('public/newhtml/images/tour07.jpg') }}" alt="" class="img-responsive">
        </figure>
        <div class="caption">
          <div class="txt1">family tour in greece</div>
          <div class="txt2">
    ...
    <div class="tour1 clearfix">
      <a href="#" class="clearfix">
        <figure>
          <img src="{{ url('public/newhtml/images/tour08.jpg') }}" alt="" class="img-responsive">
        </figure>
        <div class="caption">
          <div class="txt1">family tour in greece</div>
          <div class="txt2">
    ...
    <div class="row">
      <div class="col-sm-2">
        <div class="partner1">
          <a href="#" class="clearfix">
            <figure>
              <img src="{{ url('public/newhtml/images/partner1.jpg') }}" alt="" class="img-responsive">
              <img src="{{ url('public/newhtml/images/partner1_hover.jpg') }}" alt="" class="img-responsive hover">
            </figure>
          </a>
        </div>
      </div>
      <div class="col-sm-2">
        <div class="partner1">
          <a href="#" class="clearfix">
            <figure>
              <img src="{{ url('public/newhtml/images/partner2.jpg') }}" alt="" class="img-responsive">
              <img src="{{ url('public/newhtml/images/partner2_hover.jpg') }}" alt="" class="img-responsive hover">
            </figure>
          </a>
        </div>
      </div>
      <div class="col-sm-2">
        <div class="partner1">
          <a href="#" class="clearfix">
            <figure>
              <img src="{{ url('public/newhtml/images/partner3.jpg') }}" alt="" class="img-responsive">
              <img src="{{ url('public/newhtml/images/partner3_hover.jpg') }}" alt="" class="img-responsive hover">
            </figure>
          </a>
        </div>
      </div>
      <div class="col-sm-2">
        <div class="partner1">
          <a href="#" class="clearfix">
            <figure>
              <img src="{{ url('public/newhtml/images/partner4.jpg') }}" alt="" class="img-responsive">
              <img src="{{ url('public/newhtml/images/partner4_hover.jpg') }}" alt="" class="img-responsive hover">
            </figure>
          </a>
        </div>
      </div>
      <div class="col-sm-2">
        <div class="partner1">
          <a href="#" class="clearfix">
            <figure>
              <img src="{{ url('public/newhtml/images/partner5.jpg') }}" alt="" class="img-responsive">
              <img src="{{ url('public/newhtml/images/partner5_hover.jpg') }}" alt="" class="img-responsive hover">
            </figure>
          </a>
        </div>
      </div>
      <div class="col-sm-2">
        <div class="partner1">
          <a href="#" class="clearfix">
            <figure>
              <img src="{{ url('public/newhtml/images/partner6.jpg') }}" alt="" class="img-responsive">
              <img src="{{ url('public/newhtml/images/partner6_hover.jpg') }}" alt="" class="img-responsive hover">
            </figure>
          </a>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="city1 clearfix">
              <a href="tour-details-map.html" class="clearfix">
                <figure>
                  <img src="{{ url('public/newhtml/images/i1.jpg') }}" alt="" class="img-responsive">
                </figure>
                <div class="over"></div>
                <div class="caption">
          ...
          <div class="col-sm-6">
            <div class="city1 clearfix">
              <a href="tour-details-map.html" class="clearfix">
                <figure>
                  <img src="{{ url('public/newhtml/images/i2.jpg') }}" alt="" class="img-responsive">
                </figure>
                <div class="over"></div>
                <div class="caption">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="city1 clearfix">
              <a href="tour-details-map.html" class="clearfix">
                <figure>
                  <img src="{{ url('public/newhtml/images/i3.jpg') }}" alt="" class="img-responsive">
                </figure>
                <div class="over"></div>
                <div class="caption">
          ...
          <div class="col-sm-6">
            <div class="city1 clearfix">
              <a href="tour-details-map.html" class="clearfix">
                <figure>
                  <img src="{{ url('public/newhtml/images/i4.jpg') }}" alt="" class="img-responsive">
                </figure>
                <div class="over"></div>
                <div class="caption">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="city1 clearfix">
              <a href="tour-details-map.html" class="clearfix">
                <figure>
                  <img src="{{ url('public/newhtml/images/f1.jpg') }}" alt="" class="img-responsive">
                </figure>
                <div class="over"></div>
                <div class="caption">
          ...
          <div class="col-sm-6">
            <div class="city1 clearfix">
              <a href="tour-details-map.html" class="clearfix">
                <figure>
                  <img src="{{ url('public/newhtml/images/f2.jpg') }}" alt="" class="img-responsive">
                </figure>
                <div class="over"></div>
                <div class="caption">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="city1 clearfix">
              <a href="tour-details-map.html" class="clearfix">
                <figure>
                  <img src="{{ url('public/newhtml/images/f3.jpg') }}" alt="" class="img-responsive">
                </figure>
                <div class="over"></div>
                <div class="caption">
          ...
          <div class="col-sm-6">
            <div class="city1 clearfix">
              <a href="tour-details-map.html" class="clearfix">
                <figure>
                  <img src="{{ url('public/newhtml/images/f4.jpg') }}" alt="" class="img-responsive">
                </figure>
                <div class="over"></div>
                <div class="caption">
...
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery-ui.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery-migrate-1.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_004.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/superfish.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/select2.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/camera.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_002.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_006.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_003.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_008.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_005.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_011.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_012.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_007.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/SmoothScroll.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_010.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery_009.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/cform.js') }}"></script>

<script type="text/javascript" src="{{ url('public/newhtml/js/js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/scripts.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/bootstrap.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/bootstrap.min.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jqBootstrapValidation.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/clean-blog.min.js') }}"></script>
<script type="text/javascript" src="{{ url('public/newhtml/js/jquery.bootcomplete.js') }}"></script>
  
<script type="text/javascript" charset="UTF-8" src="{{ url('public/newhtml/js/common.js') }}"></script>
<script type="text/javascript" charset="UTF-8" src="{{ url('public/newhtml/js/util.js') }}"></script>
<script type="text/javascript" charset="UTF-8" src="{{ url('public/newhtml/js/stats.js') }}"></script>
<script type="text/javascript" charset="UTF-8" src="{{ url('public/newhtml/js/map.js') }}"></script>
<script type="text/javascript" charset="UTF-8" src="{{ url('public/newhtml/js/marker.js') }}"></script>
<script type="text/javascript" charset="UTF-8" src="{{ url('public/newhtml/js/onion.js') }}"></script>
<script type="text/javascript" charset="UTF-8" src="{{ url('public/newhtml/js/controls.js') }}"></script>
