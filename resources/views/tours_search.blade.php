...
<div class="container">
  <div class="col-md-12" style="margin-bottom:50px">
    <div class="package"> <small>Explore the world</small> {{ strtoupper($search_tour) }} </div>
  </div>
  <div class="col-md-3">
    <div class="left-bar">
  ...
  <div class="col-md-9" id="listtours">
    ...
    <div class="right-bar grid-view">
     ...
     <div class="grid-right" style="width:auto;"> 
       ...
       <p style="text-align:center">{!! $tour->days !!} days & {!! $tour->nights !!} Nights</p> <br /> <br />
        ...
        </a> <a href="{{ url('/tourdetail') }}/{!! $tour->tour_id !!}">
        <button class="btn btn-lg btn-book">View Details</button>
        </a> <a href="#" class="getacall" tid="{!! $tour->tour_id !!}">
    ...
    @endforeach
    <div class="pagination"> {{ $tours->appends(request()->input())->links() }} </div>
     @endif
     </div>
