...
<ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"> Add Hotel Type </li>
</ol>
</div>
  <div class="row">
    <div class="col-sm-12"> 
	@if(Session::has('success'))
      ...
      <div class="panel panel-default" id="panelbg">
        ...
        <div class="panel-body">
          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('hoteltype') }}">
        {{ csrf_field() }}
        
        <div class="form-group{{ $errors->has('catname') ? ' has-error' : '' }}">
          <label for="name" class="col-md-4 control-label">Hotel Type Name</label>
          <div class="col-md-4">
            <input id="hoteltype" type="text" class="form-control" name="hoteltype" value="{{ old('hoteltype') }}" required autofocus>
            @if ($errors->has('hoteltype')) <span class="help-block"> <strong>{{ $errors->first('hoteltype') }}</strong> </span> @endif </div>
        </div>
      
        <div class="form-group">
          <div class="col-md-6 col-md-offset-4">
            <button type="submit" class="btn btn-primary"> Add Hotetype </button>
          </div>
        </div>
      </form>
          </div>
