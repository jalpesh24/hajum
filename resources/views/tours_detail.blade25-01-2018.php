...
<div class="row" style="border:1px solid #333333;background: rgba(0, 18, 28, 0.45) none repeat scroll 0 0;">
  <div class="col-md-10 col-sm-10 col-xs-12">
    ...
    <!-- <ul class="option">
      ...
      <li><img src="{{ url('/img/stars-icon.png') }}" class="sign">
        <p>Accommodation</p>
      </li>
    ...
    @if($tour->inclusion_select != "")
          <ul class="option">
            @foreach(explode(',', $tour->inclusion_select) as $info) 
              ...
              @endif
               @if($info == "meals") 
                <li><img src="{{ url('/img/meals-icon.png') }}" class="sign">
                 <p>Meals</p>
                </li> 
              @endif
               @if($info == "sightseen") 
    ...
    <div class="bootom-tag"> <span><img src="{{ url('/img/tag.png') }}" alt="Special offer" title="Special offer"/>
      ...
      <div class="col-lg-11 col-md-11 col-sm-10 col-xs-8 bhoechie-tab">
        ...
        <div class="bhoechie-tab-content active" >
          <div class="col-md-12 col-sm-12 col-xs-12" style="background:#001421 !important;min-height:80px; height:auto;padding-top: 20px;" >
            <div style="float:left; padding:5px 35px 5px 0;"> <img src="{{ url('/img/hotel.png') }}" style="height:32px;"> </div>
          ...
          @if($sights[0])
          <div class="col-md-12 col-sm-12 col-xs-12" style="background:#001421 !important;min-height:80px; height:auto;padding-top: 20px;" >
            <div style="float:left; padding:5px 35px 5px 0;"> <img src="{{ url('/img/sightseen.png') }}" style="height:32px;"> </div>
            <div style="float:left;">
              <h5 style="color:#fff;">
          ...
          @if($meals[0])
          <div class="col-md-12 col-sm-12 col-xs-12" style="background:#001421 !important;min-height:80px; height:auto;padding-top: 20px;" >
            <div style="float:left; padding:5px 35px 5px 0;"> <img src="{{ url('/img/meal.png') }}" style="height:32px;"> </div>
            <div style="float:left;">
              <h5 style="color:#fff;">
                <ul style="padding:0px">
