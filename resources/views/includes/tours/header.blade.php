...
<div class="container-fluid">
  ...
  <div class="col-sm-2 where-go"> <small>Where do you want to go?</small><br>
    <div class="dropdown" style="float:left;">
      <form action="{{ url('/search') }}">
        <input type="text" name="txt_search_india" class="form-control" placeholder="Where do you want to go?" />
      </form>
    </div>
  </div>
  <div class="col-sm-4 social" align="center"> <img src="{{ url('public/img/facebook.png') }}"> <img src="{{ url('public/img/youtube.png') }}"> <img src="{{ url('public/img/googleplus.png') }}"> <img src="{{ url('public/img/instagram.png') }}"> <img src="{{ url('public/img/linkedin.png') }}"> <img src="{{ url('public/img/pinterest.png') }}"> </div>
  <div class="col-sm-3 call-us"> <small class="enquiry">Call Us for enquiries:</small> <big>1 800 707-44-09</big>
    <style>
  ...
  font-size: 14px;
    ...
    <form action="{{ url('/search') }}" class="search-form">
      <div class="form-group has-feedback">
        ...
        <img src="{{ url('public/img/search.png') }}"  class="search-img" align="right"> </div>
    </form>
  </div>
  <div class="col-md-1 last-border"><a href="{{ url('/login') }}"><img src="{{ url('public/img/default_avatar.png') }}"  class="sign" align="right"></a> </div>
</div>
<!-- /.container -->
<hr />
<!-- Page Header -->
...
<header class="intro-header">
  <div class="container">
    <div class="row">      
      <div class="col-md-12">
      <div class="logo-package"><a href="{{ url('/') }}"><!-- <img src="{{ url('public/img/logo.png') }}" alt="logo"> -->Hajum</a></div>
