<div class="bot1">
  ...
  .box {
	...
	.container label{font-size:15px !important;}
  </style>
  <div class="container">
    <div class="row">   
      <div class="col-md-3 col-sm-4 col-xs-4">
        <label style="border-bottom:1px solid;font-size: 15px !important;">Company</label>        
        <ul class="box">
      ...
      <div class="col-md-3 col-sm-4 col-xs-4" >
        <label style="border-bottom:1px solid;font-size: 15px !important;">Services</label>
        <ul class="box">
          <?php if(isset($index)) { ?>
          <?php } else { ?>
          <?php } ?>
      ...
      <div class="col-md-3 col-sm-4 col-xs-4">
        <label style="border-bottom:1px solid;font-size: 15px !important;">Help</label>
        <ul class="box">
      ...
      <div class="col-md-3 col-sm-8 col-xs-8" >
        <label style="border-bottom:1px solid;font-size: 15px !important;">News letter</label>
