...
<ol class="breadcrumb">
  ...
  <div class="col-md-12" style="margin-bottom:50px">
    <div class="package"> <strong>Explore the world</strong> <h2 style="text-align:center;"> SPECIAL OFFERS </h2></div>
  </div>
  <div class="col-md-3">
    <div class="left-bar">
  ...
  <div class="col-md-9" id="listtours"> @if(isset($tours))
    ...
    <div class="col-md-9">
        ...
        <ul class="option">
          ...
          <li style="width: 25%;float: left;list-style: none;"><img src="{{ url('public/img/stars-icon.png') }}" class="sign" style="width:25px;">
            <p>Accommodation</p>
          </li>
