...
?>
          <div class="panel-body">
            <div class="row">
              ...
              <input type="hidden" name="price_per_person" id="price_per_person" value="{!! $totalsvalue !!}" />
			  ...
			  <input type="hidden" name="amount" id="amount" value="{!! $totalsvalue !!}" />
			  ...
			  ?>
                ...
                <h4><small>Duration : Chekin: {!! $hotel[0]->checkin_time !!} To Checkout: {!! $hotel[0]->checkout_time !!}</small></h4>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="col-xs-12 col-md-12 col-sm-12">
                <div>
                  <h4><small> @if($hotel_room[0]->hotel_saleprice != '' && $hotel_room[0]->hotel_saleprice > 0)
					  <?php $totals= ($diff_in_days * $hotel_room[0]->hotel_saleprice); ?>
					  <h4 class="text-right subtotal">Sub Total: <strong class="subtotal">Rs {!! $totals !!}</strong></h4>					  
                    <h4 class="text-right total">Total: <strong class="total">Rs {!! $totals !!}</strong></h4>
                    @else
						<h4 class="text-right subtotal">Sub Total: <strong class="subtotal">Rs {!! $hotel_room[0]->hotel_saleprice !!}</strong></h4>					 
                    <h4 class="text-right total">Total: <strong class="total">Rs {!! $totals !!}</strong></h4>
                    @endif </small></h4>
                </div>
              </div>
...
function addchildage(childrens)
{
	alert(childrens);
}
